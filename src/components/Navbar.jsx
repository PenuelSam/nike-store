...
import { SearchIcon, ShoppingBagIcon, HeartIcon } from '@heroicons/react/outline'
            ...
            <nav className='flex items-center justify-between nike-container'>
                ...
                <ul className='flex items-center justify-center gap-2 '>
                    <li className='grid items-center'>
                        <SearchIcon className={`icon-style ${navState && "text-slate-900 transition-all duration-300"}`} />
                    </li>
                    <li className='grid items-center'>
